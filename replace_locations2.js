...
// Replace Add Location section in Edit Project
let target2 = `<div className="flex items-center justify-between mb-3">
...
let replacement2 = `<div className="flex items-center justify-between mb-3">
